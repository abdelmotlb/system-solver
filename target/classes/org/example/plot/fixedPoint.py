...
plt.title("Fixed point method (start tracing from orange line)")
plt.plot(xlist, ylist, color='r')
plt.plot(xlist, xAxis, color='black')
plt.plot(xlist, xlist, color='blue')
plt.plot(verticalx, verticaly, color='orange')
plt.plot(horizontalx, horizontaly, color='green')
plt.grid()
plt.show()
